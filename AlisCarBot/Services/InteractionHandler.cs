...
using AlisCarBot.Extensions.Snowflake;

namespace AlisCarBot.Services {
    internal sealed class InteractionHandler(DiscordSocketClient client, ILogger<InteractionHandler> logger, IServiceProvider provider, InteractionService service, IHostEnvironment environment, IOptions<StartupOptions> options)
        ...
        private async Task OnReady() {
            Globals.MainGuild = Client.GetGuild(options.Value.DevGuildId);
